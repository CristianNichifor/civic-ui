...
The package and lockfile are versioned together for each release. The v0.6.0
...
Version 0.6.0 is the current published GitHub release:

```bash
npm install --save-exact https://github.com/CristianNichifor/civic-ui/releases/download/v0.6.0/civic-ui-0.6.0.tgz
```
