...
Version 0.5.0 is the current published release. Existing v0.4.0, v0.3.0 and v0.2.0 assets remain unchanged. See the [adoption guide](ADOPTION.md) for the React and CSS-only archives and verification steps.
